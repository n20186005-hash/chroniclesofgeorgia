    ...
    <div className="min-h-screen bg-[#fafafa] dark:bg-[#0a0a0a] text-gray-800 dark:text-gray-100 font-sans selection:bg-gray-200 dark:selection:bg-gray-800 transition-colors duration-300">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
          <h2 className="text-5xl md:text-7xl font-serif font-medium text-white mb-6 tracking-wide drop-shadow-lg">
            {t('title')}
          </h2>
          <p className="text-lg md:text-2xl text-white/90 mb-10 font-light tracking-wide drop-shadow-md">
            {t('subtitle')}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <div className="flex items-center text-white bg-black/30 backdrop-blur-md px-6 py-2 rounded-full border border-white/20">
            ...
            <div className="text-white bg-black/30 backdrop-blur-md px-6 py-2 rounded-full border border-white/20 font-medium tracking-wide">
              {t('openHours')}
            </div>
          </div>
          <div className="flex justify-center gap-6">
            <a href="#map" className="bg-white text-gray-900 px-8 py-3.5 rounded text-sm font-semibold tracking-wider uppercase hover:bg-gray-100 transition-colors">
              {t('mapLink')}
            </a>
            <a href="#gallery" className="bg-transparent border border-white text-white px-8 py-3.5 rounded text-sm font-semibold tracking-wider uppercase hover:bg-white/10 transition-colors">
              {t('galleryLink')}
            </a>
          </div>
        </div>
      ...
      {/* 3. About */}
      <section id="about" className="py-24 bg-white dark:bg-[#0f0f0f] transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-3xl font-serif text-gray-900 dark:text-white mb-8">{tAbout('title')}</h3>
              <p className="text-gray-500 dark:text-gray-400 mb-10 leading-relaxed font-light text-lg">
                {tAbout('description')}
              </p>
              <ul className="space-y-6">
                {Object.values(tAbout.raw('highlights')).map((item: any, index) => (
                  <li key={index} className="flex items-start">
                    ...
                    <span className="text-gray-600 dark:text-gray-300 font-light">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            <div className="relative h-[600px]">
              <img 
                ...
                className="w-full h-full object-cover rounded shadow-sm grayscale-[20%] dark:grayscale-[40%] transition-all duration-300"
              />
            </div>
          </div>
        </div>
      ...
      {/* 4. Explore */}
      <section id="explore" className="py-24 bg-[#fafafa] dark:bg-[#0a0a0a] border-t border-gray-100 dark:border-gray-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      {/* 5. Gallery */}
      <section id="gallery" className="py-24 bg-white dark:bg-[#0f0f0f] transition-colors duration-300 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      {/* 6. Tips & Info */}
      <section id="tips" className="py-24 bg-[#fafafa] dark:bg-[#0a0a0a] border-y border-gray-100 dark:border-gray-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            {/* Tips */}
            <div>
              <h3 className="text-3xl font-serif text-gray-900 dark:text-white mb-10">{tTips('title')}</h3>
              <div className="space-y-10">
                {tipsItems.map((item, index) => (
                  <div key={index}>
                    <h4 className="text-sm font-bold tracking-widest text-gray-900 dark:text-gray-200 uppercase mb-4">{item.title}</h4>
                    <p className="text-gray-500 dark:text-gray-400 font-light leading-relaxed">{item.desc}</p>
                  </div>
                ))}
              </div>
            ...
            {/* Practical Info */}
            <div id="info">
              <h3 className="text-3xl font-serif text-gray-900 dark:text-white mb-10">{tInfo('title')}</h3>
              <div className="bg-white dark:bg-[#151515] p-8 border border-gray-100 dark:border-gray-800 shadow-sm rounded-xl transition-colors duration-300">
                <div className="divide-y divide-gray-100 dark:divide-gray-800">
                  <div className="py-5 flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-900 dark:text-gray-200 font-medium w-32 flex-shrink-0">{tInfo('address.label')}</span>
                    <span className="text-gray-500 dark:text-gray-400 font-light sm:text-right mt-2 sm:mt-0">{tInfo('address.value')}</span>
                  </div>
                  <div className="py-5 flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-900 dark:text-gray-200 font-medium w-32 flex-shrink-0">{tInfo('hours.label')}</span>
                    <span className="text-gray-500 dark:text-gray-400 font-light sm:text-right mt-2 sm:mt-0">{tInfo('hours.value')}</span>
                  </div>
                  <div className="py-5 flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-900 dark:text-gray-200 font-medium w-32 flex-shrink-0">{tInfo('howToGet.label')}</span>
                    <span className="text-gray-500 dark:text-gray-400 font-light sm:text-right mt-2 sm:mt-0">{tInfo('howToGet.value')}</span>
                  </div>
                  <div className="py-5 flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-900 dark:text-gray-200 font-medium w-32 flex-shrink-0">{tInfo('parking.label')}</span>
                    <span className="text-gray-500 dark:text-gray-400 font-light sm:text-right mt-2 sm:mt-0">{tInfo('parking.value')}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* 7. Reviews */}
      <section id="reviews" className="py-24 bg-white dark:bg-[#0f0f0f] transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h3 className="text-3xl font-serif text-gray-900 dark:text-white mb-4">{tReviews('title')}</h3>
            <p className="text-gray-500 dark:text-gray-400 font-light">{tReviews('declaration')}</p>
          </div>
          {/* Expanded to 8 reviews with a clean grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {reviews.map((review, index) => (
              <div key={index} className="p-8 border border-gray-100 dark:border-gray-800 rounded-xl bg-white dark:bg-[#151515] hover:border-gray-200 dark:hover:border-gray-700 hover:shadow-sm transition-all duration-300 flex flex-col h-full">
                <div className="flex text-yellow-400 text-sm mb-5">★★★★★</div>
                <p className="text-gray-600 dark:text-gray-300 font-light leading-relaxed mb-8 text-sm flex-grow">"{review.text}"</p>
                <div className="flex items-center justify-between border-t border-gray-50 dark:border-gray-800/50 pt-5 mt-auto">
      ...
      {/* 8. Map Section */}
      <section id="map" className="py-24 bg-[#fafafa] dark:bg-[#0a0a0a] border-t border-gray-100 dark:border-gray-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <div className="w-full h-[500px] rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800">
            <iframe 
